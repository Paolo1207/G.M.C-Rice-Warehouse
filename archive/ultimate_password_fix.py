#!/usr/bin/env python3
"""
Ultimate Password Fix - Generate exact hashes that match your app
Run this locally and copy the output to pgAdmin 4
"""
...
print()
print("-- Admin user")
print(f"INSERT INTO users (email, password_hash, role, branch_id) VALUES")
