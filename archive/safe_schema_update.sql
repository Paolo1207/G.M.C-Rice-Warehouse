-- SAFE Schema Update - Only creates tables if they don't exist
...
-- Only add missing branches (won't affect existing ones)
...
-- Only add missing products (won't affect existing ones)
...
-- Only add users if they don't exist (won't affect existing users)
